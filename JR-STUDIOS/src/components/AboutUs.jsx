    ...
    return (
        <section ref={containerRef} className="w-full bg-black relative overflow-hidden py-24" id={id}>
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-10">
                    <div className="grid grid-cols-12 h-full w-full">
                        {Array(12).fill(0).map((_, i) => (
                            <div key={i} className="border-r border-neon-gold-400/20"></div>
                        ))}
                    </div>
                    <div className="grid grid-rows-12 h-full w-full">
                        {Array(12).fill(0).map((_, i) => (
                            <div key={i} className="border-b border-neon-gold-400/20"></div>
                        ))}
                    </div>
                </div>
                ...
                {/* Floating circles */}
                <motion.div
                    className="absolute -right-20 top-1/4 w-80 h-80 rounded-full border border-neon-gold-500/20 opacity-30"
                    style={{ y: translateY }}
                />
                <motion.div
                    className="absolute -left-40 top-1/2 w-96 h-96 rounded-full border border-neon-gold-500/20 opacity-20"
                    style={{ y: useTransform(scrollYProgress, [0, 1], [-50, 100]) }}
                />

                {/* Gold accent line */}
                <div className="absolute left-0 top-0 w-px h-full bg-gradient-to-b from-transparent via-neon-gold-500 to-transparent opacity-70"></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-8 relative z-10">
                ...
                <div ref={headerRef} className="mb-16">
                    ...
                    >
                        <div className="h-px w-12 bg-neon-gold-500 mr-4"></div>
                        <h4 className="text-neon-gold-300 text-lg font-medium tracking-wider">ABOUT US</h4>
                    </motion.div>
            ...
            <span className="relative inline-block">
              ...
              <span className="relative ml-2">
                ...
                <motion.span
                    className="absolute bottom-0 left-0 right-0 h-3 bg-neon-gold-500/20 rounded-sm -z-0"
                    initial={{ width: 0 }}
                ...
                />
                        ...
                        <span className="text-neon-gold-200">Than an Agency</span>
                    </motion.h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    ...
                    <div className="relative">
                        <motion.div
                            className="relative aspect-square w-full bg-black/50 rounded-md backdrop-blur-sm border border-neon-gold-400/30 overflow-hidden"
                        ...
                        >
                            ...
                            <div className="absolute top-0 right-0 w-20 h-20">
                                <svg width="100%" height="100%" viewBox="0 0 100 100" fill="none">
                                    <path d="M100 0V30H70" stroke="#F59E0B" strokeWidth="1" />
                                </svg>
                            </div>
                            <div className="absolute bottom-0 left-0 w-20 h-20">
                                <svg width="100%" height="100%" viewBox="0 0 100 100" fill="none">
                                    <path d="M0 100V70H30" stroke="#F59E0B" strokeWidth="1" />
                                </svg>
                            </div>

                            {/* Glowing Dot */}
                            <motion.div
                                className="absolute top-6 right-6 w-2 h-2 rounded-full bg-neon-gold-400"
                                animate={{ boxShadow: ['0 0 0px rgba(251, 191, 36, 0.7)', '0 0 10px rgba(251, 191, 36, 0.7)', '0 0 0px rgba(251, 191, 36, 0.7)'] }}
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.div variants={contentAnimation} className="flex">
                                <div className="w-12 h-12 rounded-md bg-neon-gold-800/20 border border-neon-gold-400/30 flex items-center justify-center mr-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-neon-gold-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <Link href="/services">
                            ...
                            >
                                ...
                                <span className="absolute inset-0 bg-gradient-to-r from-neon-gold-500 to-neon-gold-300 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
